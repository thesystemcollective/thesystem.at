export const View = ({ artists, collectives }) => [
  ...
  div({ class: 'content' }, [
    div({ class: 'manifest' }, [
      ...
      h3('No Walls'),
      p(
        'The exhibition "No Walls" aims to create a decentralized, localized exhibition all over Vienna and other cities.',
      ),
      p(
        'This includes multiple exhibitions, interventions and collaborations that will get executed over the next year.',
      ),
      p(
        'We will focus on all areas of life in which our freedoms are restricted, on retracing of power structures and on dissolving them.',
      ),

      h3('No Walls For Artists'),
      p(
        'Starting in may, we will feature artists and their artworks. Featured artworks can be positioned anywhere.',
      ),

      h3('No Walls for Education / Science'),
      p(
        'We will collaborate with institutions, exhibitions and collectives, working together to represent our shared visions.',
      ),
