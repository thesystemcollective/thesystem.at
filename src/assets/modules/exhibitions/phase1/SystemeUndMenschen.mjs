export const View = () =>
  ExhibitionWrapper({
    ...
    img: {
      src: '/exhibitions/phase1/systemeundmenschen/thesystem-stizz-systemeundmenschen.jpg',
      height: 1200,
      width: 900,
    },
    ...
    exhibitionImages: [
      {
        src: '/exhibitions/phase1/systemeundmenschen/thesystem-stizz-systemeundmenschen-01.jpg',
        height: 900,
        width: 1200,
      },
      {
        src: '/exhibitions/phase1/systemeundmenschen/thesystem-stizz-systemeundmenschen-02.jpg',
        height: 675,
        width: 1200,
      },
      {
        src: '/exhibitions/phase1/systemeundmenschen/thesystem-stizz-systemeundmenschen-03.jpg',
        height: 900,
        width: 1200,
      },
    ],
